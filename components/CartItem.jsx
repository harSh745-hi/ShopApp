...
const CartItem = ({item,itemIndex}) => {
  ...
  return (
    <div className="flex items-center p-2 md:p-5 justify-between   mt-2 mb-2 md:mx-5  border-b-2 border-gray-400">
       ...
       <div className="md:ml-10 self-start space-y-5 w-[100%] md:w-[70%]">
           <h1 className="text-xl text-slate-700 font-semibold" >{item.title}</h1>
           <h1 className="text-base text-slate-700 font-medium">{item.descrption}</h1>
